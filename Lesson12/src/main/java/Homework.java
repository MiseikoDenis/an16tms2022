public class Homework {
     ...
     * 2 - й. Содержит слова недопустимые в тексте (black list). Структура файла определите сами, хотите каждое слово на новой строке,
     * хотите через запятую разделяйте.
     ...
     * Преобразовать прочитанные данные в объект hw5.Car (название полей редактировать нельзя, добавлять поля также нельзя)
     * и вывести на консоль объект через System.out.println();
     *
     */
}
